...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2024 at 06:33 PM
...
CREATE TABLE `tbl_mobil` (
  ...
  `status_mobil` enum('Berjalan','Stay','Booking') DEFAULT NULL,
...
INSERT INTO `tbl_mobil` (`id`, `nama`, `warna`, `no_polisi`, `jumlah_kursi`, `tahun_beli`, `status_mobil`, `gambar`, `id_merk`) VALUES
...
(15, 'Suzuki All New Ertiga', 'Putih', 'R 1739 KN', 8, 2018, 'Stay', 'suzuki-all-new-ertiga-1724602888.png', 9),
(21, 'All New Avanza', 'Abu abu', 'T 1234 WB', 7, 2024, 'Berjalan', 'all-new-avanza-1724600994.png', 8),
(22, 'Avanza', 'Hitam', 'T 1234 NM', 6, 2024, 'Stay', 'avanza-1724603036.png', 8),
(23, 'Swift', 'Merah', 'D 1919 TY', 5, 2022, 'Stay', 'swift-1724603535.jpg', 9);
...
(8, 'Desi', 'Cicaheum', 'P', 'desi-1724598367.png');
